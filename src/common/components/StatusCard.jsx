...
const StatusCard = ({ deviceId, position, onClose, disableActions, desktopPadding = 0 }) => {
  ...
  return (
    <>
          ...
          >
            <Card elevation={3} className={classes.card}>
              ...
              <CardActions className={classes.actions} disableSpacing>
                ...
                <Tooltip title={t('familyTitle')}>
                  <span>
                    <IconButton
                      aria-label={t('familyTitle')}
                      onClick={() => setFamilyOpen(true)}
                      disabled={disableActions || readonly || limitCommands}
                    >
                      <FamilyRestroomIcon />
                    </IconButton>
                  </span>
      ...
      {familyOpen && device && !disableActions && !readonly && !limitCommands && (
        <FamilyDialog key={device.id} device={device} onClose={closeFamily} />
      )}
      {position && (
